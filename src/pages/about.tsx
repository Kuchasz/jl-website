...
const About: NextPage = () => {
  return (
    <div className="container mb-8 flex flex-col">
      <div className="flex flex-col lg:flex-row rounded-xl bg-gray-100 overflow-clip text-gray-800">
        <img className="max-w-none lg:max-w-lg object-cover object-center" src={p1.src}></img>
